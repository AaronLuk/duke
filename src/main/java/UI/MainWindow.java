...
public class MainWindow extends AnchorPane {
    ...
    private Image userImage = new Image(this.getClass().getResourceAsStream("/images/dankCrimson.jpg"));
    private Image dukeImage = new Image(this.getClass().getResourceAsStream("/images/sfin.jpg"));
